...
program
    ...
    .option('--pub_key [filename]', 'Public key output file', 'jwt_pub.pem')
    .option('--priv_key [filename]', 'Private key output file', 'jwt_priv.pem')
...
program
    ...
    .option('--priv_key [filename]', 'Private key file', 'jwt_priv.pem')
